<template>
    <div class="protol">
       <div class="protolheader">
          <el-form :inline="true" :model="formInline" class="demo-form-inline" :rules="addRules" ref="formInline">
       ...
       <el-dialog title="协议管理" :visible.sync="dialogTableVisible" width="50%">
...
export default {
   ...
   methods: {
      protol(){
         Compile(Base64.encode(editor.getValue())).then(res=>{
            if(res){
               this.$message({
               type: "success",
              message: "编译成功"
