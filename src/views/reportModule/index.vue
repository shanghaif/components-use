<template>
	<div class="reportmodule">
		...
		<div class="reportlist">
			<el-table :data="tableData" stripe style="width: 100%">
      		...
      		{{scope.row.data.category}}
				...
				<el-table-column label="检验标准">
					<template slot-scope="scope">
						<span>
      		{{scope.row.data.inspection_standard}}
      	</span>
					</template>
				</el-table-column>
			...
			<div class="block">
				<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[5, 10,20]" :page-size="length" layout="total, sizes, prev, pager, next, jumper" :total="total">
				</el-pagination>
			</div>
		</div>
		<!--弹窗-->
		<el-dialog title="模板详情" :visible.sync="dialogTableVisible" width="50%" style="padding:20px;box-sizing: border-box;">
